            ...
            if ("photo".equals(key)) {
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                    	...
                    	if (act.locationFlag==false)
        				{
        					BluToast.makeText(act, "未定位，请先开启定位", BluToast.LENGTH_SHORT).show();
        					return;
        				} 
                    	...
                    	new Thread(new Runnable() {
							...
							@Override
            				public void run() {
            					String page=String.format("http://api.tianditu.gov.cn/geocoder?postStr={'lon':%f,'lat':%f,'ver':1}&type=geocode&tk=8def3f7faf6692b23bc854cb90041acb",act.currentLon,act.currentLat);
            					URL urlString;
            					try {
    							    ...
    							    GeocoderJSONHandler h=new GeocoderJSONHandler();
