	...
	public boolean onSingleTapUp(MotionEvent e) {
		...
		else if (state==1)
		{
			...
			new Thread(new Runnable() {
				...
				@Override
				public void run() {
					String page=String.format("http://api.tianditu.gov.cn/drive?postStr={\"orig\":\"%f,%f\",\"dest\":\"%f,%f\",\"style\":\"0\"}&type=search&tk=8def3f7faf6692b23bc854cb90041acb",lon1,lat1,lon2,lat2);
					URL urlString;
					try {
